...
module Antbird
  module RestApi
    module RestApiV7_2
      ...
      # scripts_painless_context ["GET"]
      # 
      def scripts_painless_context(params = {})
        api_name = 'scripts_painless_context'
        api_spec = @api_specs[api_name] ||= {"stability"=>"experimental", "methods"=>["GET"], "url"=>{"paths"=>["/_scripts/painless/_context"], "parts"=>{}, "params"=>{"context"=>{"type"=>"string", "description"=>"Select a specific context to retrieve API information about"}}}}
        request(api_name, api_spec, params)
      end
