  ...
  module RestApi
    module RestApiV7_15
      ...
      def indices_disk_usage(params = {})
        ...
        api_spec = @api_specs[api_name] ||= {"url" => {"paths" => [{"path" => "/{index}/_disk_usage", "methods" => ["POST"]}]}}
        request(api_name, api_spec, params, [:index])
      end
      ...
      def indices_field_usage_stats(params = {})
        ...
        api_spec = @api_specs[api_name] ||= {"url" => {"paths" => [{"path" => "/{index}/_field_usage_stats", "methods" => ["GET"]}]}}
        request(api_name, api_spec, params, [:index])
      end
      ...
      def nodes_clear_repositories_metering_archive(params = {})
        ...
        api_spec = @api_specs[api_name] ||= {"url" => {"paths" => [{"path" => "/_nodes/{node_id}/_repositories_metering/{max_archive_version}", "methods" => ["DELETE"]}]}}
        request(api_name, api_spec, params, [:node_id, :max_archive_version])
      end
      ...
      def nodes_get_repositories_metering_info(params = {})
        ...
        api_spec = @api_specs[api_name] ||= {"url" => {"paths" => [{"path" => "/_nodes/{node_id}/_repositories_metering", "methods" => ["GET"]}]}}
        request(api_name, api_spec, params, [:node_id])
      end
      ...
      def open_point_in_time(params = {})
        ...
        api_spec = @api_specs[api_name] ||= {"url" => {"paths" => [{"path" => "/{index}/_pit", "methods" => ["POST"]}]}}
        request(api_name, api_spec, params, [:index])
      end
      ...
      def search_mvt(params = {})
        api_name = 'search_mvt'
        api_spec = @api_specs[api_name] ||= {"url" => {"paths" => [{"path" => "/{index}/_mvt/{field}/{zoom}/{x}/{y}", "methods" => ["POST", "GET"]}]}}
        request(api_name, api_spec, params, [:index, :field, :zoom, :x, :y])
      end
      ...
      def security_query_api_keys(params = {})
        ...
        api_spec = @api_specs[api_name] ||= {"url" => {"paths" => [{"path" => "/_security/_query/api_key", "methods" => ["GET", "POST"]}]}}
        request(api_name, api_spec, params, [])
      end
