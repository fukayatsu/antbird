  ...
  module RestApi
    module RestApiV5_5
      ...
      def _delete_template(params = {})
        ...
        api_spec = @api_specs['delete_template'] ||= {"documentation"=>"https://www.elastic.co/guide/en/elasticsearch/reference/5.x/search-template.html", "methods"=>["DELETE"], "url"=>{"path"=>"/_search/template/{id}", "paths"=>["/_search/template/{id}"], "parts"=>{"id"=>{"type"=>"string", "description"=>"Template ID", "required"=>true}}, "params"=>{}}, "body"=>nil}
        request(api_spec, params)
      end
      ...
      def _get_script(params = {})
        ...
        api_spec = @api_specs['get_script'] ||= {"documentation"=>"https://www.elastic.co/guide/en/elasticsearch/reference/5.x/modules-scripting.html", "methods"=>["GET"], "url"=>{"path"=>"/_scripts/{lang}", "paths"=>["/_scripts/{lang}", "/_scripts/{lang}/{id}"], "parts"=>{"id"=>{"type"=>"string", "description"=>"Script ID", "required"=>true}, "lang"=>{"type"=>"string", "description"=>"Script language", "required"=>true}}, "params"=>{}}, "body"=>nil}
        request(api_spec, params)
      end
      ...
      def _get_template(params = {})
        ...
        api_spec = @api_specs['get_template'] ||= {"documentation"=>"https://www.elastic.co/guide/en/elasticsearch/reference/5.x/search-template.html", "methods"=>["GET"], "url"=>{"path"=>"/_search/template/{id}", "paths"=>["/_search/template/{id}"], "parts"=>{"id"=>{"type"=>"string", "description"=>"Template ID", "required"=>true}}, "params"=>{}}, "body"=>nil}
        request(api_spec, params)
      end
      ...
      def _info(params = {})
        ...
        api_spec = @api_specs['info'] ||= {"documentation"=>"https://www.elastic.co/guide/", "methods"=>["GET"], "url"=>{"path"=>"/", "paths"=>["/"], "parts"=>{}, "params"=>{}}, "body"=>nil}
        request(api_spec, params)
      end
      ...
      def _ingest_delete_pipeline(params = {})
        ...
        api_spec = @api_specs['ingest.delete_pipeline'] ||= {"documentation"=>"https://www.elastic.co/guide/en/elasticsearch/plugins/5.x/ingest.html", "methods"=>["DELETE"], "url"=>{"path"=>"/_ingest/pipeline/{id}", "paths"=>["/_ingest/pipeline/{id}"], "parts"=>{"id"=>{"type"=>"string", "description"=>"Pipeline ID", "required"=>true}}, "params"=>{"master_timeout"=>{"type"=>"time", "description"=>"Explicit operation timeout for connection to master node"}, "timeout"=>{"type"=>"time", "description"=>"Explicit operation timeout"}}}, "body"=>nil}
        request(api_spec, params)
      end
      ...
      def _ingest_get_pipeline(params = {})
        ...
        api_spec = @api_specs['ingest.get_pipeline'] ||= {"documentation"=>"https://www.elastic.co/guide/en/elasticsearch/plugins/5.x/ingest.html", "methods"=>["GET"], "url"=>{"path"=>"/_ingest/pipeline/{id}", "paths"=>["/_ingest/pipeline", "/_ingest/pipeline/{id}"], "parts"=>{"id"=>{"type"=>"string", "description"=>"Comma separated list of pipeline ids. Wildcards supported"}}, "params"=>{"master_timeout"=>{"type"=>"time", "description"=>"Explicit operation timeout for connection to master node"}}}, "body"=>nil}
        request(api_spec, params)
      end
      ...
      def _ingest_put_pipeline(params = {})
        ...
        api_spec = @api_specs['ingest.put_pipeline'] ||= {"documentation"=>"https://www.elastic.co/guide/en/elasticsearch/plugins/5.x/ingest.html", "methods"=>["PUT"], "url"=>{"path"=>"/_ingest/pipeline/{id}", "paths"=>["/_ingest/pipeline/{id}"], "parts"=>{"id"=>{"type"=>"string", "description"=>"Pipeline ID", "required"=>true}}, "params"=>{"master_timeout"=>{"type"=>"time", "description"=>"Explicit operation timeout for connection to master node"}, "timeout"=>{"type"=>"time", "description"=>"Explicit operation timeout"}}}, "body"=>{"description"=>"The ingest definition", "required"=>true}}
        request(api_spec, params)
      end
      ...
      def _ingest_simulate(params = {})
        ...
        api_spec = @api_specs['ingest.simulate'] ||= {"documentation"=>"https://www.elastic.co/guide/en/elasticsearch/plugins/5.x/ingest.html", "methods"=>["GET", "POST"], "url"=>{"path"=>"/_ingest/pipeline/_simulate", "paths"=>["/_ingest/pipeline/_simulate", "/_ingest/pipeline/{id}/_simulate"], "parts"=>{"id"=>{"type"=>"string", "description"=>"Pipeline ID", "required"=>false}}, "params"=>{"verbose"=>{"type"=>"boolean", "description"=>"Verbose mode. Display data output for each processor in executed pipeline", "default"=>false}}}, "body"=>{"description"=>"The simulate definition", "required"=>true}}
        request(api_spec, params)
      end
      ...
      def _ping(params = {})
        ...
        api_spec = @api_specs['ping'] ||= {"documentation"=>"https://www.elastic.co/guide/", "methods"=>["HEAD"], "url"=>{"path"=>"/", "paths"=>["/"], "parts"=>{}, "params"=>{}}, "body"=>nil}
        request(api_spec, params)
      end
      ...
      def _remote_info(params = {})
        ...
        api_spec = @api_specs['remote.info'] ||= {"documentation"=>"http://www.elastic.co/guide/en/elasticsearch/reference/5.5/cluster-remote-info.html", "methods"=>["GET"], "url"=>{"path"=>"/_remote/info", "paths"=>["/_remote/info"], "params"=>{}}, "body"=>nil}
        request(api_spec, params)
      end
      ...
      def _snapshot_delete(params = {})
        ...
        api_spec = @api_specs['snapshot.delete'] ||= {"documentation"=>"https://www.elastic.co/guide/en/elasticsearch/reference/5.x/modules-snapshots.html", "methods"=>["DELETE"], "url"=>{"path"=>"/_snapshot/{repository}/{snapshot}", "paths"=>["/_snapshot/{repository}/{snapshot}"], "parts"=>{"repository"=>{"type"=>"string", "required"=>true, "description"=>"A repository name"}, "snapshot"=>{"type"=>"string", "required"=>true, "description"=>"A snapshot name"}}, "params"=>{"master_timeout"=>{"type"=>"time", "description"=>"Explicit operation timeout for connection to master node"}}}, "body"=>nil}
        request(api_spec, params)
      end
